...
Procedure OMSXGui_OpenWindow(ParentWindow)
  ...
  Protected G_Transfer    = ButtonGadget(#PB_Any, 24, 54, 280, 30, "Transferir programa atual")
  ...
  Protected G_DiskBrowse  = ButtonGadget(#PB_Any, 622, 34, 50, 24, "...")
  Protected G_DiskInsert  = ButtonGadget(#PB_Any, 676, 34, 90, 24, "Inserir")
  Protected G_DiskEject   = ButtonGadget(#PB_Any, 770, 34, 90, 24, "Ejetar")

  TextGadget(#PB_Any, 24, 70, 70, 20, "Cartucho:")
  Protected G_CartPath    = StringGadget(#PB_Any, 98, 66, 520, 24, "")
  Protected G_CartBrowse  = ButtonGadget(#PB_Any, 622, 66, 50, 24, "...")
  Protected G_CartInsert  = ButtonGadget(#PB_Any, 676, 66, 90, 24, "Inserir")
  Protected G_CartEject   = ButtonGadget(#PB_Any, 770, 66, 90, 24, "Ejetar")

  TextGadget(#PB_Any, 24, 102, 70, 20, "Cassete:")
  Protected G_CasPath     = StringGadget(#PB_Any, 98, 98, 520, 24, "")
  Protected G_CasBrowse   = ButtonGadget(#PB_Any, 622, 98, 50, 24, "...")
  Protected G_CasInsert   = ButtonGadget(#PB_Any, 676, 98, 90, 24, "Inserir")
  Protected G_CasEject    = ButtonGadget(#PB_Any, 770, 98, 90, 24, "Ejetar")
  ...
  Protected G_Send       = ButtonGadget(#PB_Any, WinW - 198, 456, 102, 24, "Enviar" + Chr(9) + "Enter")
  ...
  Protected G_Speed100   = ButtonGadget(#PB_Any, 624, 36, 80, 28, "100%")
  ...
  Protected G_Power       = ButtonGadget(#PB_Any, 24, 110, 130, 28, "Power: ?")
  Protected G_Reset       = ButtonGadget(#PB_Any, 164, 110, 100, 28, "Reset")
  Protected G_Pause       = ButtonGadget(#PB_Any, 274, 110, 130, 28, "Pause: ?")

  Protected G_Firmware    = ButtonGadget(#PB_Any, 24, 150, 220, 28, "Firmware: ?")
  ...
  Protected G_Rensha      = ButtonGadget(#PB_Any, 254, 150, 220, 28, "Ren Sha Turbo: ?")
  ...
  Protected G_VSync   = ButtonGadget(#PB_Any, 396, 36, 100, 26, "VSync: ?")
  ...
  Protected G_Deinterlace   = ButtonGadget(#PB_Any, 24, 98, 140, 26, "Deinterlace: ?")
  Protected G_LimitSprites  = ButtonGadget(#PB_Any, 174, 98, 150, 26, "Limitar sprites: ?")
  Protected G_Fullscreen    = ButtonGadget(#PB_Any, 334, 98, 120, 26, "Tela cheia: ?")
  Protected G_DisableSprites = ButtonGadget(#PB_Any, 464, 98, 170, 26, "Desabilitar sprites: ?")
  ...
  Protected G_ScanlineReset = ButtonGadget(#PB_Any, 480, 204, 70, 26, "Reset")
  ...
  Protected G_BlurReset = ButtonGadget(#PB_Any, 480, 236, 70, 26, "Reset")
  ...
  Protected G_GlowReset = ButtonGadget(#PB_Any, 480, 268, 70, 26, "Reset")
  ...
  Protected G_GammaReset = ButtonGadget(#PB_Any, 480, 300, 70, 26, "Reset")
  ...
  Protected G_NoiseReset = ButtonGadget(#PB_Any, 480, 332, 70, 26, "Reset")
  ...
  Protected G_ShotDirBrowse = ButtonGadget(#PB_Any, 768, 406, 50, 24, "...")
  Protected G_ShotTake = ButtonGadget(#PB_Any, 24, 440, 240, 28, "Capturar screenshot")
  ...
  Protected G_Stop = ButtonGadget(#PB_Any, 440, 518, 100, 30, "STOP")
  ...
  Protected G_DeviceAdd     = ButtonGadget(#PB_Any, 364, 38, 90, 24, "Adicionar")
  ...
  Protected G_DevMute = ButtonGadget(#PB_Any, 440, 188, 160, 28, "Mudo (Volume 0)")
  ...
  Protected G_MidiInBrowse     = ButtonGadget(#PB_Any, 516, 282, 50, 24, "...")
  Protected G_MidiInConnect    = ButtonGadget(#PB_Any, 572, 282, 90, 24, "Conectar")
  Protected G_MidiInDisconnect = ButtonGadget(#PB_Any, 668, 282, 110, 24, "Desconectar")
  ...
  Protected G_MidiOutBrowse     = ButtonGadget(#PB_Any, 516, 334, 50, 24, "...")
  Protected G_MidiOutConnect    = ButtonGadget(#PB_Any, 572, 334, 90, 24, "Conectar")
  Protected G_MidiOutDisconnect = ButtonGadget(#PB_Any, 668, 334, 110, 24, "Desconectar")
  ...
  Protected G_AudioLog = ButtonGadget(#PB_Any, 210, 396, 220, 26, "Gravar / Parar log de audio")
  ...
  Protected G_TypeGo    = ButtonGadget(#PB_Any, 24, 530, 160, 30, "Type")
  Protected G_TypeClear = ButtonGadget(#PB_Any, 194, 530, 100, 30, "Clear")
  ...
  Protected G_Restart    = ButtonGadget(#PB_Any, 24, 712, 160, 30, "Reiniciar openMSX")
  Protected G_ShowWindow = ButtonGadget(#PB_Any, 194, 712, 140, 30, "Mostrar janela")
  Protected G_Help       = ButtonGadget(#PB_Any, 344, 712, 90, 30, "Ajuda")
  Protected G_Close      = ButtonGadget(#PB_Any, WinW - 109, 712, 85, 30, "Fechar")
